...
const useClapState = (initialState = INITIAL_STATE) => {
  ...
  return { clapState, updateClapState, counterProps, reset };
};
...
const MediumClap = () => {
  const { clapState, updateClapState, counterProps } =
  ...
  return (
    <span>
      <svg
        ...
        className={`${styles.icon} ${isClicked ? styles.checked : null}`}
      >
